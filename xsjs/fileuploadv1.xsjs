//This to handle files with number line less than number of column as mention https://scn.sap.com/community/developer-center/hana/blog/2015/09/09/xsimport--a-hana-app-for-importing-csvs
...
function previewFile() {
    ...
    if (contents.length > 0) {
        ...
        line = line.split("\",\"");
        //previous var col = line.splice(0, arrLines.length + 1);
